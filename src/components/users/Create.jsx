        ...
        <div className="col py-3">
            <form onSubmit={sendData}>
                <div className='mb-3'>
                    ...
                    <input id='username' name='name' className='form-control' type='text' onChange={ handleData}/>
                </div>

                <div className='mb-3'>
                    <label htmlFor='email'>email</label>
                    <input id='email' type='email' name='email' className='form-control'   onChange={ handleData}/>
                 </div>
                 <div className='mb-3'>
                    <label htmlFor='password'>password</label>
                    <input id='password' type='password' name='password' className='form-control' onChange={ handleData}/>
                </div>

                <div className='mb-3'>
                    <input type='submit' className='form-control' value='AddUser' />
                </div>
            </form>
        </div>
    </div>
